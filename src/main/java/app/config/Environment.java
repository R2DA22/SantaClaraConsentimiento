...
import infrastructure.handlers.professional.FindProfessionalBySpecialityHandler;
...
public class Environment {
    ...
    public Environment() throws Exception {
        ...
        FindProfessionalBySpecialityUseCase findProfessionalBySpecialityUseCase = new FindProfessionalBySpecialityUseCase(professionalRepository);
        ...
        FindProfessionalBySpecialityHandler findProfessionalBySpecialityHandler = new FindProfessionalBySpecialityHandler(findProfessionalBySpecialityUseCase);
        ...
        queryBus.register(SpecialityList.class.getName(), findAllSpecialityHandler);
        queryBus.register(Professional.class.getName(), findProfessionalHandler);
        queryBus.register(Speciality.class.getName(), findProfessionalBySpecialityHandler);
